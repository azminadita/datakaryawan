...
@section('content')
    <div class="card">
        ...
        <h3 class="card-title">
            <a href="/karyawan/form/" class="btn btn-primary"><i class="fa fa-folder-plus"></i> Tambah Data</a>
        </h3>
            ...
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/karyawan/edit/{{$item->id}}" class="btn btn-info btn-sm"><i class="fa fa-pencil-alt"></i></a>

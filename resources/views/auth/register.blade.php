...
<div class="login-box">
    ...
    <div class="card">
	    ...
	    <div class="input-group mb-3">
		<input placeholder="Masukkan Confirm Password" id="password-confirm" type="password" class="form-control @error('password') is-invalid @enderror" name="password_confirmation" required autocomplete="current-password">
